...
<form action="{{ url('/tendik/' . $tendik->tendik_id . '/update_ajax') }}" method="POST" id="form-edit">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" style="font-weight: bold;">Edit Data Tendik</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>NIDN</label>
                        <input type="text" class="form-control" id="tendik_nidn" name="tendik_nidn" value="{{ $tendik->tendik_nidn }}" required>
                        <small id="error-tendik_nidn" class="error-text form-text text-danger"></small>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>No. HP</label>
                        <input type="text" class="form-control" id="tendik_noHp" name="tendik_noHp" value="{{ $tendik->tendik_noHp }}" required>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="text" class="form-control" id="tendik_nama" name="tendik_nama" value="{{ $tendik->tendik_nama }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="username" name="username" value="{{ $tendik->user->username }}" required>
                ...
                success: function(response) {
                    if (response.status) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Gagal!',
                            text: response.message || 'Gagal mengupdate data tendik.',
                        });
                    }
                },
                error: function(xhr) {
