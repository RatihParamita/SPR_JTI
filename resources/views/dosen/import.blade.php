<form action="{{ url('/dosen/import_ajax') }}" method="POST" id="form-import" enctype="multipart/form-data" onsubmit="importDosen(event)">
    @csrf
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" style="font-weight: bold;">Impor Data Dosen</h5>
        ...
        <div class="modal-body">
            <div>
                ...
                <br>
                <a href="{{ asset('templates/template_dosen.xlsx') }}" class="btn btn-sm btn-import" download>
