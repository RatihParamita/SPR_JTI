...
<div class="card" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    <div class="card-header">
        ...
        <div class="d-flex align-items-center w-100">
            ...
            <div class="d-flex align-items-center mx-3">
                ...
                <select class="form-control form-control-sm" id="dosen_prodi" name="dosen_prodi" style="width: 200px;">
            ...
            <div class="d-flex align-items-center mx-3">
                ...
                <input type="text" class="form-control form-control-sm" id="dosen_search" name="dosen_search" placeholder="Cari berdasarkan nama">
            ...
            <div class="card-tools ml-auto my-1">
                <button onclick="modalAction('{{ url('/dosen/create_ajax') }}')" class="btn btn-success btn-sm">
                    <i class="fas fa-plus"></i> Tambah
                </button>
                <button onclick="modalAction('{{ url('/dosen/import') }}')" class="btn btn-sm btn-import">
    ...
    <div class="card-body">
        ...
        {{-- Tabel Data Dosen --}}
        <table class="table table-sm" id="table_dosen">
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="Aksi">
                            <button onclick="modalAction('{{ url('/dosen/' . $dosen->dosen_id . '/show_ajax') }}')" class="btn btn-outline-info btn-sm" title="Detail">
                                <i class="fas fa-eye"></i>
                            </button>
                            <button onclick="modalAction('{{ url('/dosen/' . $dosen->dosen_id . '/edit_ajax') }}')" class="btn btn-outline-warning btn-sm" title="Edit">
                                <i class="fas fa-edit"></i>
                            </button>
                            <button onclick="modalAction('{{ url('/dosen/' . $dosen->dosen_id . '/confirm_ajax') }}')" class="btn btn-outline-danger btn-sm" title="Hapus">
...
<div class="modal fade" id="modalDosen" tabindex="-1" role="dialog" aria-labelledby="modalDosenTitle" aria-hidden="true">
...
<script>
    ...
    function modalAction(url) {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#modalDosen .modal-content').html(data);
    ...
    $(document).ready(function() {
        ...
        var dosenDosen = $('#table_dosen').DataTable({
            autoWidth: false,
            responsive: true,
